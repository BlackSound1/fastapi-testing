...
async def send_email(
    ...
    :param to_email: Who is sending the email?
    :param subject: The subject of the email.
    :param plain_text: The plain text of the email.
    :param html_content: Optional HTML content for the email.
    """
...
async def send_password_reset_email(to_email: str, username: str, token: str) -> None:
    """
    Send an email for resetting passwords.

    :param to_email: Who the email is to.
